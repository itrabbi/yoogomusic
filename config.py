...
# Get this value from @YooGoXBot on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6355601354"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/itrabbi/yoogomusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/YooGoX")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/YooGoXchat")
...
# Get your pyrogram v2 session from @rabbisudo on Telegram
